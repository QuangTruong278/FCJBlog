...
![Cert 1](/static/images/project/certificate/cert-1.png)

4. Enter Domain name (e.g., `*.example.com`).
![Cert 2](/static/images/project/certificate/cert-2.png)
...
![Cert 3](/static/images/project/certificate/cert-3.png)
![Cert 4](/static/images/project/certificate/cert-4.png)
